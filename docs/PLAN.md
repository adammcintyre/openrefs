...
- [ ] Repo scaffold: single package, Worker (Hono) + SPA (Vite/React/Tailwind v4) via `@cloudflare/vite-plugin`, wrangler.jsonc with D1/KV/R2/assets/cron bindings, strict TS, vitest, CI workflow, AGPL LICENSE, README
- [ ] Drizzle schema + initial migration (core tables per ARCHITECTURE.md), local migrations working
